...
<div style="background-color: #36596F; width: 100%; height: 35px; text-align: center; position: absolute; z-index: 20; left: 0; top: 0; border-top-left-radius: 15px; border-top-right-radius: 15px">
    <p style="color: white; font-size: larger; margin-top: 5px; font-family: Arial">Battle with other Pokemon</p>
</div>
...
<div id="status" class="animated fadeInRight">
    ...
    <p id="pika"><?php echo $pikachuname ?> <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
</div>
<div id="oppstatus" class="animated fadeInLeft">
    ...
    <p id="opp"><?php echo $pokemonname ?> <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
</div>
<div id="menu" class="animated fadeInRight">
    <div>
        <button onclick="alert('You must login to play')">Fight</button>
        <button onclick="alert('You must login to play')">Bait</button>
        <br>
        <button onclick="alert('You must login to play')">Pokeball</button>
        <button onclick="alert('You must login to play')">Run</button>
    </div>
</div>
</body>
</html>